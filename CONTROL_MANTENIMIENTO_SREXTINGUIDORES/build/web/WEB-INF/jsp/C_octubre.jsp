...
<html>
    <head>
        ...
        <link href="css_octubre/nuevo.css" rel="stylesheet" type="text/css"/>
        ...
        <div class="nuevo">
            <div class="container">
                <form method="POST">
                    ...
                    <input type="text" name="id" placeholder="Ingrese el correlativo" class="form-control" id="validationDefaultUsername"  aria-describedby="inputGroupPrepend2" required>
                    ...
                    <input type="text" name="valor" placeholder="Ingrese el Total de la Factura" class="form-control" id="validationDefaultUsername"  aria-describedby="inputGroupPrepend2" required>
                    <label class="l">FECHA</label>
                    <input type="date" name="fecha" placeholder="Ingrese el Nombre del Cliente" class="form-control" id="validationDefaultUsername"  aria-describedby="inputGroupPrepend2" required>
