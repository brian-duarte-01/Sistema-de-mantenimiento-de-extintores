...
<html>
    <head>
        ...
        <link href="css_cli_deudor/reporte.css" rel="stylesheet" type="text/css"/>
        <title>Reporte de Clientes Deudores | Srextinguidores</title>
    </head>
    <body>

        <div class="titulo">
            <h1 class="ti">Reporte de Clientes Deudores</h1>
        </div>
        ...
        <div class="reporte">
            <div class="container">
                <div class="botones">
                    ...
                    <a class="btn btn-warning" href="ldeudor.htm">
