<%-- 
    Document   : RE_julio
    Created on : mar 22, 2022, 8:54:46 p.m.
...
<html>
    <head>
        ...
        <link href="css_julio/reporte.css" rel="stylesheet" type="text/css"/>
        <title>Reporte | Srextinguidores</title>
    </head>
    <body>
        <div class="titulo">
            <h1 class="ti">Reporte de Clientes en Mantenimiento del Mes de Julio</h1>
        </div>
