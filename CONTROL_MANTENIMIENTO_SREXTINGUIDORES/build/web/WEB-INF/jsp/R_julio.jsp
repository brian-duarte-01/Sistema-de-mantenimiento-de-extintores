...
<html>
    <head>
        ...
        <link href="css_julio/listar.css" rel="stylesheet" type="text/css"/>
        <title>Extintores en Mantenimiento | Srextinguidores</title>
    </head>
    <body>
        <div class="titulo">
            <h1 class="ti">Clientes en Mantenimiento del Mes de Julio</h1>
        </div>
        ...
        <div class="listar">
            <div class="container">
                <div class="botones">
                    <a class="btn btn-dark" href="ajulio.htm">
                    ...
                    <a class="btn btn-dark" href="rjulio.htm">
                                ...
                                <c:forEach var="dato" items="${lista}">
                                    <tr>
                                        ...
                                        <td class="td">
                                            ...
                                            <a class="btn btn-danger" href="ujulio.htm?id=${dato.ID}">
                                            ...
                                            <a class="btn btn-success" href="djulio.htm?id=${dato.ID}">
