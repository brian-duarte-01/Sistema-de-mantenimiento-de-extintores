...
<html>
    <head>
        ...
        <link href="css_cli_deudor/actualizar.css" rel="stylesheet" type="text/css"/>
        <title>Actualizar Cliente Deudor | Srextinguidores</title>
    </head>
    <body>

        <div class="titulo">
            <h1 class="ti">Actualizar Cliente Deudor</h1>
        </div>
                ...
                <form method="POST" class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="no_factura" value="${lista[0].NO_FACTURA}" placeholder="Ingrese el numero de factura" class="form-control" id="validationDefaultUsername"  aria-describedby="inputGroupPrepend2" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="total" value="${lista[0].TOTAL}" placeholder="Ingrese el total de la factura"  class="form-control" id="validationDefaultUsername"  aria-describedby="inputGroupPrepend2" required>
                        </div>
                    </div>
