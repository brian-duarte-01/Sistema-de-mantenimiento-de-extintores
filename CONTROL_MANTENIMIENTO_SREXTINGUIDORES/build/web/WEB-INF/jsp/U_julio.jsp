<%-- 
    Document   : U_julio
    Created on : mar 22, 2022, 8:26:07 p.m.
...
<html>
    <head>
        ...
        <link href="css_julio/actualizar.css" rel="stylesheet" type="text/css"/>
        ...
        <div class="nuevo">
            <div class="container">
                <form method="POST">
                    ...
                    <input type="text" name="valor" value="${lista[0].VALOR}" class="form-control" id="validationDefaultUsername"  aria-describedby="inputGroupPrepend2" required>
                    <label class="l">FECHA</label>
                    <input type="date" name="fecha" value="${lista[0].FECHA}" class="form-control" id="validationDefaultUsername"  aria-describedby="inputGroupPrepend2" required>
                    ...
                    <div class="botones">
                        ...
                        <a class="btn btn-warning" href="ljulio.htm">
