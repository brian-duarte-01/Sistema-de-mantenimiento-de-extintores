...
<html>
    <head>
        ...
        <link href="clientes/reporte.css" rel="stylesheet" type="text/css"/>
        <title>Reporte clientes | Srextinguidores</title>
    </head>
    <body>

        <div class="titulo">
            <h1 class="ti">Reporte de Clientes</h1>
        </div>
