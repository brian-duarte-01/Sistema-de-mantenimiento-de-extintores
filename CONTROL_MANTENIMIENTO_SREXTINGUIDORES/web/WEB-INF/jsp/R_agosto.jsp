...
<html>
    <head>
        ...
        <link href="css_agosto/listar.css" rel="stylesheet" type="text/css"/>
        <title>Extintores en Mantenimiento | Srextinguidores</title>
    </head>
    <body>
        <div class="titulo">
            <h1 class="ti">Clientes en Mantenimiento del Mes de Agosto</h1>
        </div>
        ...
        <div class="listar">
            <div class="container">
                <div class="botones">
                    <a class="btn btn-dark" href="aagosto.htm">
                    ...
                    <a class="btn btn-dark" href="ragosto.htm">
                            ...
                            <tbody>
                                <c:forEach var="dato" items="${lista}">
                                    <tr>
                                        ...
                                        <td class="td">
                                            <a class="btn btn-danger" href="uagosto.htm?id=${dato.ID}">
                                            ...
                                            <a class="btn btn-success" href="dagosto.htm?id=${dato.ID}">
