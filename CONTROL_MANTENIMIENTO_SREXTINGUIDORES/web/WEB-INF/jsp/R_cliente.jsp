...
<html>
    <head>
        ...
        <link href="clientes/listar.css" rel="stylesheet" type="text/css"/>
        <title>Clientes | Srextinguidores</title>
    </head>
    <body>


        <div class="titulo">
            <h1 class="ti">Panel de Clientes</h1>
        </div>
        ...
        <div class="listar">
            <div class="container">
                <div class="botones">
                                    ...
                                    <form method="POST" class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="nit" placeholder="Ingrese el nit del cliente" class="form-control" id="validationDefaultUsername"  aria-describedby="inputGroupPrepend2" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="telefono" placeholder="Ingrese el telefono del cliente" class="form-control" id="validationDefaultUsername"  aria-describedby="inputGroupPrepend2" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="email" name="correo" placeholder="Ingrese el correo del cliente" class="form-control" id="validationDefaultUsername"  aria-describedby="inputGroupPrepend2" required>
                                            </div>
                                        </div>
                    ...
                    <a class="btn btn-dark" href="rcliente.htm">
                            ...
                            <tbody>
                                <c:forEach var="dato" items="${lista}">
                                    <tr>
                                        ...
                                        <td class="td">
                                            <a class="btn btn-danger" href="acliente.htm?id=${dato.CORRELATIVO}">
                                            ...
                                            <a class="btn btn-success" href="dcliente.htm?id=${dato.CORRELATIVO}">
