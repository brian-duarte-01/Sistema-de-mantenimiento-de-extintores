...
<html>
    <head>
        ...
        <link href="css_diciembre/listar.css" rel="stylesheet" type="text/css"/>
        <title>Extintores en Mantenimiento | Srextinguidores</title>
    </head>
    <body>

        <div class="titulo">
            <h1 class="ti">Clientes en Mantenimiento del Mes de Diciembre</h1>
        </div>

        <div class="listar">
            <div class="container">
                <div class="botones">
                    <a class="btn btn-dark" href="adiciembre.htm">
                    ...
                    <a class="btn btn-dark" href="rdiciembre.htm">
                            ...
                            <tbody>
                                <c:forEach var="dato" items="${lista}">
                                    <tr>
                                        ...
                                        <td class="td">
                                            <a class="btn btn-danger" href="udiciembre.htm?id=${dato.ID}">
                                            ...
                                            <a class="btn btn-success" href="ddiciembre.htm?id=${dato.ID}">
