...
<html>
    <head>
        ...
        <link href="css_septiembre/listar.css" rel="stylesheet" type="text/css"/>
        <title>Extintores en Mantenimiento | Srextinguidores</title>
    </head>
    <body>

        <div class="titulo">
            <h1 class="ti">Clientes en Mantenimiento del Mes de Septiembre</h1>
        </div>
        ...
        <div class="listar">
            <div class="container">
                <div class="botones">
                    ...
                    <a class="btn btn-dark" href="cseptiembre.htm">
                    ...
                    <a class="btn btn-dark" href="rseptiembre.htm">
                                ...
                                <c:forEach var="dato" items="${lista}">
                                    <tr>
                                        ...
                                        <td class="td">
                                            ...
                                            <a class="btn btn-danger" href="aseptiembre.htm?id=${dato.ID}">
                                            ...
                                            <a class="btn btn-success" href="dseptiembre.htm?id=${dato.ID}">
